...
public class teachericon {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//change teacher icon click
		
		WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement select0 =wait2.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.teacher__change__wrapper"))); 
		select0.click();
		  
		Thread.sleep(3000);
		// Teacher modal open hoga select krnai kai liyai hai
		  
		  
		WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement select1 = wait3.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[12]/div/div/div/div[2]/div[3]")));// 
		  //JavascriptExecutor js = (JavascriptExecutor) driver;
		 // js.executeScript("arguments[0].scrollIntoView(true);", select1);
		  //((JavascriptExecutor) driver).executeScript("arguments[0].click();",select1);  (agr teacher scroll down kr kai select krna ho)
		  
		select1.click(); //change teacher
